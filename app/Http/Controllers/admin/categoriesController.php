...
class categoriesController extends Controller
{
    ...
    public function edit($id)
    {
       $item = Category::findOrFail($id);
        return view('admin.mainCategory.edit',compact('item'));
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            if (!$category)
                return redirect()->route('main-Category.index')->with(['error' => 'error']);

            $category->delete();
            return redirect()->route('main-Category.index')->with(['success' => 'main-category successfully deleted']);
