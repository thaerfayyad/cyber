<!DOCTYPE html>
        ...
        <!-- Custom CSS -->
            ...
            <link href="{{asset('admin/assets/libs/summernote/dist/summernote-bs4.css')}}" rel="stylesheet">
            <link href="{{asset('admin/assets/libs/dropzone/dist/min/dropzone.min.css')}}" rel="stylesheet">
